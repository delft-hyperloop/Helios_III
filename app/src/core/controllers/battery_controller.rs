...
impl BatteryController {
    ...
    pub async fn battery_voltage_overall_bms(&mut self, data: &[u8], timestamp: u64) {
        ...
        if (!self.high_voltage){
            ...
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV1, avg_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV2, avg_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV3, avg_cell_voltage ,0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV4, avg_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV5, min_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV6, avg_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV7, max_cell_voltage, 0 ).await;
            queue_dp(self.data_sender, Datatype::SingleCellVoltageLV8, avg_cell_voltage, 0 ).await;
        }
