...
mod tests {
    ...
    fn printing_speed_values() {
        let route = Route {
            ...
            speeds: LocationSpeedMap(
                [
                    (Location::StraightStart, 42),
                    (Location::StraightBackwards, 42*2),
                    (Location::LaneSwitchStraight, 42*3),
                    (Location::LaneSwitchCurved, 42*4),
                    (Location::StraightEndTrack, 42*5),
                    (Location::LaneSwitchEndTrack, 42*6),
                    (Location::StopAndWait, 0),
                    (Location::BrakeHere, 0),
                ]
                    .into(),
