...
#ifndef typedef_c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T
#define typedef_c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T

typedef struct tag_zmyFJYuy9Y9RxVYqHyxNtC
  c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T;

#endif  /* typedef_c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T */
...
struct tag_ihJ14nmxy7rOIct0JsvIEB
{
  ...
  boolean_T TunablePropsChanged;
  cell_wrap_ControllerLateral_T inputVarSize;
  c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T *pStatistic;
  int32_T NumChannels;
  c_dsp_private_SlidingWindowAverageCG_ControllerLateral_n_T _pobj0;
};

#endif                                 /* struct_tag_ihJ14nmxy7rOIct0JsvIEB */

#ifndef typedef_dsp_simulink_MovingAverage_ControllerLateral_e3x_T
#define typedef_dsp_simulink_MovingAverage_ControllerLateral_e3x_T

typedef struct tag_ihJ14nmxy7rOIct0JsvIEB
  dsp_simulink_MovingAverage_ControllerLateral_e3x_T;

#endif          /* typedef_dsp_simulink_MovingAverage_ControllerLateral_e3x_T */
