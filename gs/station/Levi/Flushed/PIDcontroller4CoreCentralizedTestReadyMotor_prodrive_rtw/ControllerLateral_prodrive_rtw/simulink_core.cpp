...
namespace PmpInternal
{
  namespace DynamicLibrary
  {
    ...
    static const SNamedSignalInfo inputOffsets[22] = {
      ...
      { "CoM_y_dot", { ESimulinkStructsInput, offsetof(ExtU_ControllerLateral_T,
          CoM_y_dot), EDataTypeDouble } },

      { "com_acc_x", { ESimulinkStructsInput, offsetof(ExtU_ControllerLateral_T,
          com_acc_x), EDataTypeDouble } },

      { "PropulsionOn", { ESimulinkStructsInput, offsetof
          (ExtU_ControllerLateral_T, PropulsionOn), EDataTypeDouble } },

      { "com_spd_x", { ESimulinkStructsInput, offsetof(ExtU_ControllerLateral_T,
          com_spd_x), EDataTypeDouble } },
    };
    ...
    static const SNamedSignalInfo parameterOffsets[51] = {
      ...
      { "LS_signal", { ESimulinkStructsParameter, offsetof
          (InstP_ControllerLateral_T, LS_signal), EDataTypeDouble } },
      ...
      { "x_location_raw", { ESimulinkStructsParameter, offsetof
          (InstP_ControllerLateral_T, x_location_raw), EDataTypeDouble } },
    };
    ...
    static const SReflectionInfo reflectionInfo[109] = {
      ...
      { "CoM_y_dot", ESimulinkStructsInput },

      { "com_acc_x", ESimulinkStructsInput },

      { "PropulsionOn", ESimulinkStructsInput },

      { "com_spd_x", ESimulinkStructsInput },
      ...
      { "LS_signal", ESimulinkStructsParameter },
      ...
      { "x_location_raw", ESimulinkStructsParameter },
