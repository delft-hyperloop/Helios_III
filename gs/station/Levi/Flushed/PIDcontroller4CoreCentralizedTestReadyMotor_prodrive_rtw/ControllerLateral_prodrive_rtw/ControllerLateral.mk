...
MODEL                = ControllerLateral
MODULES              = $(subst rt_main.c , ,$(subst rt_malloc_main.c , ,ControllerLateral_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c simulink_core.cpp))
MAKEFILE             = ControllerLateral.mk
...
START_DIR            = C:\Users\ZBOOK1~1\DOWNLO~1\Simulink\Simulink
S_FUNCTIONS_LIB      = 
NUMST                = 1
TID01EQ              = 0
NCSTATES             = 0
COMPUTER             = PCWIN64
BUILDARGS            =  PMP_TOP_LEVEL_MODEL="TemplateLaserSensorsFull" PMP_SAMPLEPERIOD="0.0002500000" PMP_IS_SLAVE="off" INCLUDE_MDL_TERMINATE_FCN=1 OPTS="-DRT_MALLOC -DTID01EQ=0"
MULTITASKING         = 0
MAT_FILE             = 0
...
ADD_INCLUDES = \
	$(START_DIR) \
	$(START_DIR)\ControllerLateral_prodrive_rtw \
